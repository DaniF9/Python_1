...
miMoto = Moto("yamaha","MT09") # instanciamos miMoto
miMoto.caballito()
miMoto.estado() # Accedimos al estado  de la moto desde la clase padre 

mifur = Furgoneta("NISSAN","XL")
mifur.arrancar()
mifur.estado()
print(mifur.Carga(True))

class Bicicletaelectrica(Electricos,Vehiculos):
    pass

miBici = Bicicletaelectrica("Benoto","V200")
